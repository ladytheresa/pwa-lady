...
const getBase64 = (event) => {
    ...
    let imgblob = new Blob([event.target.files[0]]);
...
let customerToAdd = { ssn: "666-66-6666", name: "Alice", age: 28, email: "alice@example.com" };
const keyToUpdate = "666-66-6666";
let updatedCustomerData = { ssn: "666-66-6666", name: "Alice Updated", age: 30, email: "alice.updated@example.com" };
    ...
    request.onsuccess = (event) => {
        ...
        customersCursor.onsuccess = (event) => {
            ...
            if (cursor) {
                ...
                console.log("Data read successfully but didnt find cursor anymore");
...
const deleteData = () => {
    ...
    request.onsuccess = (event) => {
        ...
        deleteRequest.onsuccess = (event) => {
            ...
            customers.value.splice(0, customers.value.length); //ini hapus index 0 sampai abis jadi deleteall
        };
